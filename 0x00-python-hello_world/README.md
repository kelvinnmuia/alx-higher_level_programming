...
```
  ...
  * [2-print.py](./2-print.py): Python that prints the text `"Programming is like building a multilingual puzzle`, 
followed by a new line.

**3. Print integer**

Complete this [source code](https://github.com/alx-tools/0x00.py/blob/master/3-print_number.py) in order to print the integer 
...
```
  ...
  * [3-print_number.py](./3-print_number.py): Python script that prints an integer stored in the variable number.
...
```
  ...
  * [4-print_float.py](./4-print_float.py): Python script that prints float stored in the variable `number`.
...
```
  ...
  * [5-print_string.py](./5-print_string.py): Python scripts that prints string stored in the variable `str`.
...
```
  ...
  * [6-concat.py](./6-concat.py): Python script that concatnates `str1` and `str2`
...
```
  ...
  * [7-edges.py](./7-edges.py): python script that splits a word into first, last and middle letters.
...
```
  ...
  * [8-concat_edges.py](./8-concat_edges.py): python script that concatenates letters into words.
...
```
  ...
  * [9-easter_egg.py](./9-easter_egg.py): Python script that prints `"The Zen of Python"`
...
```
  ...
  * [10-check_cycle.c](./10-check_cycle.c): created a linked list cycle.
  * [lists.h](./lists.h)
...
```
  ...
  * [100-write.py](./100-write.py): Python script that prints `and that piece of art is useful - Dora Korpar, 2015-10-19`, followed by a new line.
