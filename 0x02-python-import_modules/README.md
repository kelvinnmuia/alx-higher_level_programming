...
```
  ...
  * [0-add.py](./0-add.py): A program that imports the function `def add(a, b):` from the file `add_0.py`
...
guillaume@ubuntu:~/0x02$
```
  * [3-infinite_add.py](./3-infinite_add.py): A python program that prints the result of the addition of all arguments.
...
```
  ...
  * [101-easy_print.py](./101-easy_print.py): Python program that prints `#pythoniscool`, followed by a new line.
...
```
  ...
  * [102-magic_calculation.py](./102-magic_calculation.py): Converting a bytecode into a python function.
