...
The project introduced me to errors and exceptions handlers in python. At the end of the project I created errors and exceptions handlers to handle errors and exceptions within my python functions and programs.
...
```
  ...
  * [0-safe_print_list.py](./0-safe_print_list.py): Python function with exception handlers that prints `x` elements of a list.
...
```
  ...
  * [1-safe_print_integer.py](./1-safe_print_integer.py): Python function with exception handlers that prints an integer with `"{:d}".format()`
...
guillaume@ubuntu:~/0x05$ 
```
  * [2-safe_print_list_integers.py](./2-safe_print_list_integers.py): Python function with exception handlers that prints the first `x` elements of a list and only integers.
...
```
  ...
  * [3-safe_print_division.py](./3-safe_print_division.py): Python function with exception handlers that divides 2 integers and prints the result.
...
```
  ...
  * [4-list_division.py](./4-list_division.py): Python function with exception handlers that divides element by element 2 lists.
...
```
  ...
  * [100-safe_print_integer_err.py](./100-safe_print_integer_err.py): Python functiont with exception that prints an integer.
...
```
  ...
  * [101-safe_function.py](./101-safe_function.py): Python function with exception that executes a function safely. 
