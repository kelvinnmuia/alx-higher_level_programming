...
```
  ...
  * [1-my_list.py](./1-my_list.py): Public instance method that inherits from `list`.
  * [1-my_list.txt](./tests/1-my_list.txt): The function test cases.
...
```
  ...
  * [2-is_same_class.py](./2-is_same_class.py): Python function that returns `True` if the object is exactly an instance 
...
```
  ...
  * [3-is_kind_of_class.py](./3-is_kind_of_class.py): Python function that returns `True` if the object is an instance of, 
...
```
  ...
  * [5-base_geometry.py](./5-base_geometry.py): Empty python class `BaseGeometry`.
...
```
  ...
  * [7-base_geometry.txt](./tests/7-base_geometry.txt): The class test cases.
