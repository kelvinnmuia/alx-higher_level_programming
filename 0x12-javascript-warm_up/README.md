...
```
  ...
  * [9-add.js](./9-add.js): JavaScript script that prints the addition of 2 integers.
...
```
  ...
  * [11-second_biggest.js](./11-second_biggest.js): JavaScript script that searches the second biggest integer in the list of arguments.
...
```
  ...
  * [13-add.js](./13-add.js): JavaScript function that returns the addition of 2 integers.
...
```
  ...
  * [100-let_me_const.js](./100-let_me_const.js): JavaScript script that modifies the value of `myVar` to `333`.
...
```
  ...
  * [103-object_fct.js](./103-object_fct.js): JavaScript script with the function `incr` that increments the integer `value`.

## 0x12. JavaScript - Warm up Quizes.

  * [0x12. JavaScript - Warm up](https://drive.google.com/file/d/1LRPRuNZclHoL0M1TcS9YGUtg050n8SA6/view?usp=sharing)
